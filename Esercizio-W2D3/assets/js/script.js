...
for (let i = 0; i < starWarsCharacters.length; i++) {
    let altezza = Number(starWarsCharacters[i].height, 10);
...
}console.log(`Il piu grande e ${nomePiuGrande} con ${piuGrande} cm e il piu basso e ${nomePiuBasso} con ${piuBasso} cm`);
